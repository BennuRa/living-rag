...
class AgentTaskCategory(StrEnum):
    """Categories used to organize deterministic Agent evaluation tasks."""
...
class ExpectedCitation(BaseModel):
    """A citation pattern expected from an Agent answer."""
...
class AgentTaskCase(BaseModel):
    ...
    expected_citations: list[ExpectedCitation] = Field(
    ...
    def normalize_text_list(cls, value: Any) -> Any:
        """Keep compatibility with legacy string-based task fields."""
